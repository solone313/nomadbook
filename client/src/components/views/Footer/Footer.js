  ...
  return (
    <footer id="footer" className="dark">
        ...
        <Row>
          <Col lg={12} sm={24} xs={24}>
            <div className="footer-center">
              ...
              <div>
                <a target="_blank " href="https://github.com/solone313/nomadbook">
                  GitHub - This repo
                </a>
              </div>
              <br/><br/>
          ...
          <Col lg={12} sm={24} xs={24}>
            <div className="footer-center">
              ...
              <div>
                <a target="_blank" rel="noopener noreferrer" href="https://www.rocketpunch.com/@wjstk1233">Rocketpunch</a>
                <span> - </span>
                류호진
              </div>
              <div>
      ...
      <Row className="bottom-bar">
        <Col lg={4} sm={24} />
        <Col lg={20} sm={24}>
          <span style={{ marginRight: 12 , fontSize: "18px" }}>
            개발: 강은현,류호진
          </span><br/>
